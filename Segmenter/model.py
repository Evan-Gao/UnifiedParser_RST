...
#        corresponding word embedding.
    ...
    def inference_decoder(self, hn, hend, lens):
        ...
        return batch_boundary, batch_boundary_start

    def inference(self, Xin_batch, lens):
        ...
        for i in range(len(Xin_batch)):
            ...
            # cur_loss, cur_boundary, cur_boundary_start, _ = self.test_decoder(encoder_hn,encoder_h_end,IndexY,lens)
            cur_boundary, cur_boundary_start = self.inference_decoder(cur_encoder_hn,
                                                                      cur_encoder_h_end,
                                                                      len_in)
